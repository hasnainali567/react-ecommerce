  ...
  return (
    <div className=' layout-content-container flex flex-col max-w-[960px] flex-1'>
      ...
      <div className='md:px-4 py-3 @container'>
        <div className='flex overflow-auto max-h-125  rounded-lg border border-[#3e3a55] bg-[#121118] scroll-bar'>
            ...
            <tbody className='overflow-auto max-h-200'>
              {products.length > 0 &&
                products.map((product) => (
                  <tr className='border-t border-t-[#3e3a55]' key={product.title}>
                    ...
                    <td onClick={() => handleEdit(product.id)} className='cursor-pointer table-ae896546-8418-4ced-b5d7-85535fe87205-column-600 h-[72px] px-4 py-2 w-60 text-[#a09bbb] text-sm font-bold leading-normal tracking-[0.015em]'>
                      Edit
                    </td>
                  </tr>
                ))}
    ...
    <EditProduct isOpen={modalOpen} setIsOpen={setModalOPen} product={editingProduct} />
    </div>
  );
};
